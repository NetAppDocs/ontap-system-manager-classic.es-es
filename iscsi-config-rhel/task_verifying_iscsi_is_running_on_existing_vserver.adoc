...
+
image::../media/vserver_service_iscsi_running_iscsi_rhel.gif[La ilustración muestra la página del protocolo iSCSI con un icono verde y el texto el servicio iSCSI está en ejecución.]
